...
- Keep export artifacts (Solution `.zip`, Canvas App `.msapp`) out of Git; store them locally under `dist/` or attach to Releases when appropriate.
...
## GCC High note (if applicable)

When targeting GCC High environments, ensure you authenticate and operate against the government endpoints appropriate to your tenant.
